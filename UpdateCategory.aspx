...
<body>
    <form id="form1" runat="server">
        <table class="auto-style1">
            <tr>
                ...
                <td>
                    <asp:Button ID="c" runat="server" Text="New" class="button" Width="98px" />
                </td>
            </tr>
            <tr>
                <td class="auto-style2">
                ...
                <td>
                    <asp:Button ID="c0" runat="server" Text="Update" Width="98px" CssClass="button" OnClick="c0_Click" />
                </td>
            </tr>
            <tr> 
                <td class="auto-style2">
    ...
    <div>
        ...
        <asp:GridView ID="GridView1" runat="server" AutoGenerateColumns="False" DataKeyNames="cid" DataSourceID="SqlDataSource1" Width="588px" CellPadding="4" ForeColor="#333333" GridLines="None" CssClass="auto-style4">
            ...
            <Columns>
                ...
                <asp:BoundField DataField="descl" HeaderText="Description" SortExpression="descl" />
            </Columns>
