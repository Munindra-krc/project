...
<body style="width: 577px; height: 317px">
    <center>
    ...
    <div>
        ...
        <table  class="auto-style1">
            <tr>
                ...
                <td class="auto-style4">
                    <asp:Button ID="c" runat="server" style="margin-left: 42px" Text="New" Width="106px"  class="button" OnClick="c_Click" />
                </td>
            </tr>
            <tr>
                <td class="auto-style5">
                ...
                <td class="auto-style3">
                    <asp:TextBox ID="t2" runat="server" onkeypress="return allowonlyalphabet()" CssClass="txt" placeholder="Enter only alphabet" ></asp:TextBox>
                </td>
                <td class="auto-style4">
                    <asp:Button ID="c0" runat="server" style="margin-left: 42px" Text="Save" Width="106px"  class="button" OnClick="c0_Click" />
                </td>
            </tr>
            <tr>
                <td class="auto-style5">
                ...
                <td class="auto-style3">
                    <asp:TextBox ID="t3" runat="server" onkeypress="return allowonlyalphabet()" class="txt" placeholder="Enter only alphabet"></asp:TextBox>
                </td>
                <td class="auto-style4">
                    <asp:Button ID="c1" runat="server" style="margin-left: 42px" Text="AllSearch"  class="button" Width="106px" OnClick="c1_Click" />
                </td>
            </tr>
            <tr>
                <td class="auto-style5">
                ...
                <td class="auto-style3">
                    <asp:TextBox ID="t4" runat="server" onkeypress="return allowonlynumber()" CssClass="txt" placeholder="Enter only number"></asp:TextBox>
                </td>
                <td class="auto-style4">
                    <asp:Button ID="c2" runat="server" style="margin-left: 42px" Text="Psearch" Width="106px"  class="button" OnClick="c2_Click" />
                    <asp:LinkButton ID="LinkButton1" runat="server"  class="button" PostBackUrl="~/menu.aspx">Home</asp:LinkButton>
                </td>
            </tr>
            <tr>
                <td class="auto-style5">
        ...
        <asp:GridView ID="GridView1" runat="server" AutoGenerateColumns="False" DataKeyNames="cid" DataSourceID="SqlDataSource1" Width="606px" CellPadding="4" ForeColor="#333333" GridLines="None">
