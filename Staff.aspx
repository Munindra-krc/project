...
<head runat="server">
    ...
    <style type="text/css">
        ...
        .auto-style3 {
            ...
            body {
            background: url(image//staff.jpg);
...
<body>
    <form id="form1" runat="server">
        <table class="auto-style1">
            <tr>
                ...
                <td>
                    <asp:Button ID="s" runat="server" Text="New" Width="93px" class="button" OnClick="s_Click" />
                &nbsp;</td>
            </tr>
            <tr>
                <td class="auto-style2">
                ...
                <td>
                    <asp:Button ID="s0" runat="server" Text="Save" Width="93px" class="button" OnClick="s0_Click" />
                </td>
            </tr>
            <tr>
                <td class="auto-style2">
                ...
                <td>
                    <asp:Button ID="s1" runat="server" Text="Allsearch" Width="93px" class="button" OnClick="s1_Click" />
                </td>
            </tr>
            <tr>
                <td class="auto-style2">
                ...
                <td>
                    <asp:Button ID="s2" runat="server" Text="Psearch" Width="93px" Class="button" OnClick="s2_Click" />
    ...
    <div>
        ...
        <asp:GridView ID="GridView1" runat="server" AutoGenerateColumns="False" DataKeyNames="stid" DataSourceID="SqlDataSource1" Width="658px" CellPadding="4" ForeColor="#333333" GridLines="None">
            <AlternatingRowStyle BackColor="White" />
            <Columns>
                <asp:BoundField DataField="stid" HeaderText="Staff Id" ReadOnly="True" SortExpression="stid" />
                <asp:BoundField DataField="sfnm" HeaderText="First Name" SortExpression="sfnm" />
                <asp:BoundField DataField="slnm" HeaderText="Last Name" SortExpression="slnm" />
