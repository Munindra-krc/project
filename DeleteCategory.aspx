...
<body>
    <form id="form1" runat="server">
        <table class="auto-style1">
            ...
            <tr>
                ...
                <td>
                    <asp:Button ID="c0" runat="server" Text="Delete" Width="98px" CssClass="button" OnClick="c0_Click" />
                </td>
            </tr>
            <tr>
                <td class="auto-style2">
            ...
            <tr>
                ...
                <td>
                    <asp:Button ID="c2" runat="server" Text="Psearch" Width="98px" CssClass="button
                        " OnClick="c2_Click" />
    ...
    <div>
        ...
        <asp:GridView ID="GridView1" runat="server" AutoGenerateColumns="False" DataKeyNames="cid" DataSourceID="SqlDataSource1" Height="168px" Width="565px" CellPadding="4" ForeColor="#333333" GridLines="None" CssClass="auto-style4">
