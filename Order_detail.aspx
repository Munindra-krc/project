...
<body>
    <form id="form1" runat="server">
        <table class="auto-style1">
            <tr>
                ...
                <td>
                    <asp:Button ID="o" runat="server" Text="New" Width="89px" class="button" OnClick="o_Click" />
                </td>
            </tr>
            <tr>
                <td class="auto-style2">
                ...
                <td>
                    <asp:Button ID="o0" runat="server" Text="Save" Width="89px" class="button" OnClick="o0_Click" />
                </td>
            </tr>
            <tr>
                <td class="auto-style2">
            ...
            <tr>
                ...
                <td class="auto-style6">
                    <asp:Button ID="o2" runat="server" Text="Psearch" Width="89px" CssClass="button" OnClick="o2_Click" />
            ...
            <tr>
                ...
                <td class="auto-style3">
                    <asp:TextBox ID="t9" runat="server" class="txt"></asp:TextBox>
                </td>
                <td>
    ...
    <div>
        ...
        <asp:GridView ID="GridView1" runat="server" AutoGenerateColumns="False" DataKeyNames="ordid" DataSourceID="SqlDataSource1" style="margin-top: 0px" Width="593px" CellPadding="4" ForeColor="#333333" GridLines="None">
