...
<body>
    <form id="form1" runat="server">
        <table class="auto-style1">
            ...
            <tr>
                ...
                <td>
                    <asp:Button ID="p0" runat="server" Text="Delete" Width="101px" class="button" OnClick="p0_Click" />
                </td>
            </tr>
            <tr>
                <td class="auto-style2">
    ...
    <div>
        ...
        <asp:GridView ID="GridView1" runat="server" AutoGenerateColumns="False" DataKeyNames="bollno" DataSourceID="SqlDataSource1" CellPadding="4" ForeColor="#333333" GridLines="None">
            <AlternatingRowStyle BackColor="White" />
            <Columns>
                <asp:BoundField DataField="bollno" HeaderText="Bill Number" ReadOnly="True" SortExpression="bollno" />
                <asp:BoundField DataField="ptype" HeaderText="Pament Type" SortExpression="ptype" />
