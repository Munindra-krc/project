...
<body>
    ...
    <div>
        ...
        <table class="auto-style1">
            <tr>
                ...
                <td class="auto-style10">
                    <asp:Button ID="b1" runat="server" Text="New" Width="84px" class="button" OnClick="b1_Click" />
                </td>
            </tr>
            <tr>
                <td class="auto-style3">
                ...
                <td class="auto-style10">
                    <asp:Button ID="b2" runat="server" Text="Save" Width="87px" CssClass="button" OnClick="b2_Click" />
                </td>
            </tr>
            <tr>
                ...
                <td class="auto-style11">
                    <asp:Button ID="b3" runat="server" Text="AllSearch" Width="86px" CssClass="button" OnClick="b3_Click" />
                </td>
            </tr>
            <tr>
                <td class="auto-style3">
                ...
                <td class="auto-style10">
                    <asp:Button ID="b4" runat="server" Text="Psearch" Width="88px" CssClass="button" OnClick="b4_Click" />
                    <asp:TextBox ID="t8" runat="server" CssClass="auto-style13" Width="160px"></asp:TextBox>
                </td>
            </tr>
            <tr>
                <td class="auto-style3">
        ...
        <asp:GridView ID="GridView1" runat="server" AutoGenerateColumns="False" DataKeyNames="sid" DataSourceID="SqlDataSource1" Width="597px" CellPadding="4" ForeColor="#333333" GridLines="None">
