<%@ Page Language="C#" AutoEventWireup="true" CodeFile="DeleteOrder1.aspx.cs" Inherits="Order" %>
...
<body>
    <form id="form1" runat="server">
        <table class="auto-style1">
            ...
            <tr>
                ...
                <td>
                    <asp:Button ID="o0" runat="server" Text="Delete" Width="98px" class="button" OnClick="o0_Click" />
                </td>
            </tr>
            <tr>
                <td class="auto-style2">
                ...
                <td>
                    <asp:Button ID="o1" runat="server" Text="AllSearch" Width="98px" CssClass="button" OnClick="o1_Click" />
                </td>
            </tr>
            <tr>
                <td class="auto-style2">
    ...
    <div>
        ...
        <asp:GridView ID="GridView1" runat="server" AutoGenerateColumns="False" DataKeyNames="ordid" DataSourceID="SqlDataSource1" Width="650px" CellPadding="4" ForeColor="#333333" GridLines="None">
