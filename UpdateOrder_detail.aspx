...
<body>
    <form id="form1" runat="server">
        <table class="auto-style1">
            <tr>
                ...
                <td>
                    <asp:Button ID="o" runat="server" Text="New" class="button" Width="89px" />
                </td>
            </tr>
            <tr>
                <td class="auto-style2">
                ...
                <td>
                    <asp:Button ID="o0" runat="server" Text="Update" Width="89px" class="button" OnClick="o0_Click" />
                </td>
            </tr>
            <tr>
                <td class="auto-style2">
            ...
            <tr>
                ...
                <td class="auto-style3">
                    <asp:TextBox ID="t6" runat="server" Class="txt"></asp:TextBox>
                </td>
                <td>&nbsp;</td>
            </tr>
            <tr>
    ...
    <div>
        ...
        <asp:GridView ID="GridView1" runat="server" AutoGenerateColumns="False" DataKeyNames="ordid" DataSourceID="SqlDataSource1" Width="604px" CellPadding="4" ForeColor="#333333" GridLines="None">
