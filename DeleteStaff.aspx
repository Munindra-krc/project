...
<body>
    <form id="form1" runat="server">
        <table class="auto-style1">
            <tr>
                ...
                <td>
                    <asp:Button ID="s" runat="server" Text="New" CssClass="button" Width="93px" />
                </td>
            </tr>
            <tr>
                <td class="auto-style2">
                ...
                <td>
                    <asp:Button ID="s0" runat="server" Text="Delete" Width="93px" CssClass="button" OnClick="s0_Click" />
                </td>
            </tr>
            <tr>
                <td class="auto-style2">
    ...
    <div>
        ...
        <asp:GridView ID="GridView1" runat="server" AutoGenerateColumns="False" DataKeyNames="stid" DataSourceID="SqlDataSource1" Width="709px" CellPadding="4" ForeColor="#333333" GridLines="None">
