...
<body style="width: 591px; height: 321px">
    ...
    <div>
        ...
        <table class="auto-style1">
            <tr>
                ...
                <td class="auto-style4">
                    <asp:Button ID="c" runat="server" Text="New" style="margin-left: 38px" CssClass="button" Width="119px" />
                </td>
            </tr>
            <tr>
                <td class="auto-style5">
                ...
                <td class="auto-style4">
                    <asp:Button ID="c0" runat="server" Text="Update" style="margin-left: 38px" Width="119px" CssClass="button" OnClick="c0_Click" />
                </td>
            </tr>
            <tr>
                <td class="auto-style5">
                ...
                <td class="auto-style4">
                    <asp:Button ID="c1" runat="server" Text="AllSearch" style="margin-left: 38px" Width="119px" class="button" OnClick="c1_Click" />
                </td>
            </tr>
            <tr>
                <td class="auto-style5">
                ...
                <td class="auto-style4">
                    <asp:Button ID="c2" runat="server" Text="Psearch" style="margin-left: 38px" Width="119px" CssClass="button" OnClick="c2_Click" />
        ...
        <asp:GridView ID="GridView1" runat="server" AutoGenerateColumns="False" DataKeyNames="cid" DataSourceID="SqlDataSource1" Width="587px" CellPadding="4" ForeColor="#333333" GridLines="None">
            <AlternatingRowStyle BackColor="White" />
            <Columns>
                <asp:BoundField DataField="cid" HeaderText="Customer Id" ReadOnly="True" SortExpression="cid" />
                <asp:BoundField DataField="cfnm" HeaderText="First Name" SortExpression="cfnm" />
                <asp:BoundField DataField="clnm" HeaderText="Last Name" SortExpression="clnm" />
