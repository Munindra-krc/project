...
<body>
    <form id="form1" runat="server">
        <table class="auto-style1">
            <tr>
                ...
                <td>
                    <asp:Button ID="p" runat="server" Text="New" CssClass="button" Width="101px" />
                </td>
            </tr>
            <tr>
                <td class="auto-style2">
                ...
                <td>
                    <asp:Button ID="p0" runat="server" Text="Update" Width="101px" CssClass="button" OnClick="p0_Click" />
                </td>
            </tr>
            <tr>
                <td class="auto-style2">
                ...
                <td>
                    <asp:Button ID="p1" runat="server" Text="AllSearch" Width="101px" CssClass="button" OnClick="p1_Click" />
                </td>
            </tr>
            <tr>
                ...
                <td>
                    <asp:Button ID="p2" runat="server" Text="PSearch" Width="101px" class="button" OnClick="p2_Click" />
    ...
    <div>
        ...
        <asp:GridView ID="GridView1" runat="server" AutoGenerateColumns="False" DataKeyNames="bollno" DataSourceID="SqlDataSource1" Width="648px" CellPadding="4" ForeColor="#333333" GridLines="None">
            ...
            <Columns>
                ...
                <asp:BoundField DataField="other" HeaderText="Other Detail" SortExpression="other" />
            </Columns>
