...
<body style="height: 261px">
    <form id="form1" runat="server">
        <table class="auto-style1">
            <tr>
                ...
                <td>
                    <asp:Button ID="pb" runat="server" Text="New" CssClass="button" Width="73px" />
                </td>
            </tr>
            <tr>
                <td class="auto-style2">
                ...
                <td>
                    <asp:Button ID="pb0" runat="server" Text="Update" Width="73px" CssClass="button" OnClick="pb0_Click" />
                </td>
            </tr>
            <tr>
                <td class="auto-style2">
                ...
                <td>
                    <asp:Button ID="pb1" runat="server" Text="Allsearch" Width="73px" CssClass="button" OnClick="pb1_Click" />
                </td>
            </tr>
            <tr>
                <td class="auto-style2">
                ...
                <td>
                    <asp:Button ID="pb2" runat="server" Text="Psearch" Width="73px" class="button" OnClick="pb2_Click" />
    ...
    <div>
        ...
        <asp:GridView ID="GridView1" runat="server" AutoGenerateColumns="False" DataSourceID="SqlDataSource1" Width="649px" CellPadding="4" ForeColor="#333333" GridLines="None">
