<%@ Page Language="C#" AutoEventWireup="true" CodeFile="Order1.aspx.cs" Inherits="Order" %>
...
<body>
    <form id="form1" runat="server">
        <table class="auto-style1">
            <tr>
                ...
                <td>
                    <asp:Button ID="o" runat="server" Text="New" Width="98px" CssClass="button" OnClick="o_Click" />
                </td>
            </tr>
            <tr>
                <td class="auto-style2">
                ...
                <td>
                    <asp:Button ID="o0" runat="server" Text="Save" Width="98px" CssClass="button" OnClick="o0_Click" />
                </td>
            </tr>
            <tr>
                <td class="auto-style2">
                ...
                <td class="auto-style3">
                    <asp:TextBox ID="t3" runat="server" class="txt"></asp:TextBox>
                </td>
                <td>
                    <asp:Button ID="o1" runat="server" Text="AllSearch" Width="98px" class="button" OnClick="o1_Click" />
            ...
            <tr>
                ...
                <td>
                    <asp:Button ID="o2" runat="server" Text="PSearch" Width="98px" class="button" OnClick="o2_Click" />
    ...
    <div>
        ...
        <asp:GridView ID="GridView1" runat="server" AutoGenerateColumns="False" DataKeyNames="ordid" DataSourceID="SqlDataSource1" Width="683px" CellPadding="4" ForeColor="#333333" GridLines="None">
            <AlternatingRowStyle BackColor="White" />
            <Columns>
                <asp:BoundField DataField="ordid" HeaderText="Order Id" ReadOnly="True" SortExpression="ordid" />
                <asp:BoundField DataField="date1" HeaderText="Order Date" SortExpression="date1" />
